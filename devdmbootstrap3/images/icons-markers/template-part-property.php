...
<div class="clearfix"></div>
<?php $lat = str_replace(",",".", $result[0]['latitude']) ; ?>
<?php $lng = str_replace(",",".", $result[0]['longitude']) ; ?>
<?php $diretorio_uri = get_template_directory_uri(); ?>
<?php $url_map = 'https://www.google.com/maps/embed/v1/place?key=AIzaSyA_WQFVl-f2sppF3_lceEf3vy2T2JI1et0
    &q='.$lat.','.$lng; ?>

<div class="map col-sm-12 no-padding home-properties">
	<h2>Localização Aproximada</h2>
	<div id="map" style="height: 450px; margin: 0 15px 15px"></div>
...
<script>
  ...
  function initialize() {
    ...
    // if (place.icon) {
      ...
      var iconBase =  <?php echo $diretorio_uri ?> + '/images/icons-markers/icon-'+lugar+'.png';
