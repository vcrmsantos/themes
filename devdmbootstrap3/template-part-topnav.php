<?php if ( has_nav_menu( 'main_menu' ) ) : ?>	
    <div class="dmbs-top-menu <?= isset($currentpage) ? $currentpage : '' ?>">
        <nav class="navbar navbar-fixed-top" role="navigation">
        	<ul class="address text-center hidden-xs">				
				<li>
				...
				<li>
					<a href="javascript:void($zopim.livechat.window.show());" title="Atendimento Online">
						<i class="fa fa-comments-o">&nbsp;</i>&nbsp;Atendimento Online
					</a>
				</li>	
				<li>
					<a href="<?php echo get_page_link(62); ?> " title="Clique aqui e veja nossos Imóveis Selecionados">
						<i class="fa fa-home">&nbsp;</i>&nbsp;Imóveis Selecionados
					</a>
				</li>	
				<li>
						...
						<?php if ( get_header_image() != '' ) : ?>
							<div class="col-md-3 dmbs-header-img text-center col-xs-9 ">
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="Lopes Erwin Maack">
									<h1>
										<img src="<?php header_image(); ?>" height="<?php echo get_custom_header()->height; ?>" width="<?php echo get_custom_header()->width; ?>" alt="Lopes Erwin Maack" />
